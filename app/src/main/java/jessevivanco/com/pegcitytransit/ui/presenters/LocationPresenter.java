...
public class LocationPresenter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    /**
     * If you're using an instance of {@link LocationPresenter}, then you must implement the view
